...
const CLIENTS = [
  {
    id: "google-review-feed",
    logo: "Google review feed",
    quote:
      "The Tiger Fuel site showcases customer reviews that are being fed directly from Google. Each feed can be customized to come from a specific Tiger location and business.",
    author:
      "After the initial setup, this allows each page to curate the reviews automatically for their specific instance, no manual updates necessary.",
  },
  {
    id: "find-a-location",
  ...
  },
  {
    ...
    logo: "Instagram feed",
    quote:
      "Several of the Tiger sites include an Instagram feed that automatically updates each time a post is added. This helps bring their sites to life without the added time of updating website page content.",
    author:
      "",
  },
  {
    id: "location-specific-pages",
    logo: "Location specific pages",
    quote:
      "Location was critical for the Tiger sites and Local SEO was a key driver of the redevelopment process. Location specific pages allowed us to rank locally for specific products and services in distinct geographic areas.",
    author:
      "",
  },
];
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <div className="flex flex-col">
                <p className="text-[12px] font-medium mb-4" style={{ color: "rgba(255,255,255,0.45)" }}>
                  Tiger project delivery highlights ↓
                </p>
