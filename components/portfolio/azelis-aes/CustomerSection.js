...
const CLIENTS = [
  {
    id: "product-catalog",
    logo: "250+ product catalog",
    quote:
      "The Azelis team had the unique challenge of combining two stand alone websites into one. A major part of this task was migrating all products from both sites and reconfiguring them on one WooCommerce installation.",
    author:
      "The initial migration included over 250+ unique products, and now houses 360+ products.",
  },
  {
    id: "product-finder",
    logo: "Product finder",
  ...
  {
    id: "expandable-education-hub",
    logo: "Expandable category-based article and education hub",
    quote:
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <div className="flex flex-col">
                <p className="text-[12px] font-medium mb-4" style={{ color: "rgba(255,255,255,0.45)" }}>
                  Azelis A&ES project delivery highlights ↓
                </p>
