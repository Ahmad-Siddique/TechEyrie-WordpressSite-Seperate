    ...
    >
      <section style={{ maxWidth: "960px", margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "1.08rem", lineHeight: 1.7, opacity: 0.9 }}>
          This is demo content for the AZELIS AES portfolio page. Replace this
          placeholder with the finalized brand story, conversion goals, execution
          notes, and post-launch KPI performance.
        </p>
        <div style={{ marginTop: "30px", padding: "20px", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "14px" }}>
          ...
          <p style={{ marginBottom: 0, lineHeight: 1.7 }}>
            Industry: B2B / Industrial | Scope: UX, Content, Development | Timeline:
            9 weeks | Status: Demo
          </p>
        </div>
      </section>
