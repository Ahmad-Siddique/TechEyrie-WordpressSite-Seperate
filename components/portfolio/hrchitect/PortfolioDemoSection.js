    ...
    >
      <section style={{ maxWidth: "960px", margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "1.08rem", lineHeight: 1.7, opacity: 0.9 }}>
          This is demo content for the HRCHITECT project page. Use this layout as a
          placeholder for final case study details, objectives, implementation
        ...
        <div style={{ marginTop: "30px", padding: "20px", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "14px" }}>
          ...
          <p style={{ marginBottom: 0, lineHeight: 1.7 }}>
            Industry: HR / Workforce Services | Scope: UX, UI, Development |
            Timeline: 8 weeks | Status: Demo
          </p>
        </div>
      </section>
    </main>
