...
const CLIENTS = [
  ...
  {
    id: "plugin-page-post-review",
    logo: "Plugin, page & post type review",
    quote:
      "The next step was to review all plugins, pages, posts and post types on the site. The purpose of this was to eliminate any excess weight on the site, especially items that were either no longer in use or had outdated content. We were able to cut the amount of plugins used in half, remove a dozen content pages that were no longer needed and cut ~1,200 various posts from the site.",
    author:
      "After these changes were made we saw an increase in speed and performance by a full letter grade according to GT Metrix.",
  },
  {
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <div className="flex flex-col">
                <p className="text-[12px] font-medium mb-4" style={{ color: "rgba(255,255,255,0.45)" }}>
                  HRchitect project delivery highlights ↓
                </p>
