    ...
    >
      <section style={{ maxWidth: "960px", margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "1.08rem", lineHeight: 1.7, opacity: 0.9 }}>
          This is demo content for ACERTUS. Use this placeholder to present your
          case study narrative, technical implementation details, and measurable
          business impact once final copy is ready.
        </p>
        <div style={{ marginTop: "30px", padding: "20px", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "14px" }}>
          ...
          <p style={{ marginBottom: 0, lineHeight: 1.7 }}>
            Industry: Logistics / Transport | Scope: SEO + Web Platform | Timeline:
            12 weeks | Status: Demo
          </p>
        </div>
      </section>
    </main>
