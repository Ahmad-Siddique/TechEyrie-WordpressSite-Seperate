...
import { getRtsRevolutionCardPic } from "../../lib/pageImages";
...
export default function RTSRevolutionSection({ pageKey: pageKeyProp }) {
  ...
  const leftCardImage = getRtsRevolutionCardPic(pageKey, 0);
  const rightCardImage = getRtsRevolutionCardPic(pageKey, 1);
        ...
        <div ref={cardsWrapperRef} className="px-6 sm:px-10 md:px-16 lg:px-20 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-4">
            <div ref={leftCardRef} className="will-change-transform">
              <CardImage
                src={leftCardImage}
                alt="Traditional fiber placement"
                badge="Before RTS"
                aspectRatio="4/3"
                footerClassName="bg-[#f5f5f5] border border-[#e0e0e0] py-5 px-5"
                footerContent={
            ...
            <div ref={rightCardRef} className="will-change-transform">
              <CardImage
                src={rightCardImage}
                alt="RTS design composite manufacturing"
                badge="RTS Design"
                aspectRatio="4/3"
                footerClassName="bg-[#f5f5f5] border border-[#e0e0e0] py-5 px-5"
                footerContent={
